        ...
        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <form class="space-y-4 md:space-y-6" action="" method="POST">
                ...
                <div>
                    ...
                    <input type="text" name="shipping_city" id="shipping_city" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 g-gray-700 order-gray-600 laceholder-gray-400 ext-white ocus:ring-blue-500 ocus:border-blue-500" placeholder="Pisa" required="" />
                </div>
                <div>
                    <label for="shipping_state" class="block mb-2 text-sm font-medium text-gray-900 ext-white">Shipping State
                    </label>
                    <input type="text" name="shipping_state" id="shipping_state" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 g-gray-700 order-gray-600 laceholder-gray-400 ext-white ocus:ring-blue-500 ocus:border-blue-500" placeholder="Italy" required="" />
                </div>
